...
![](./write2pics/later/fill_internal_array_with_pointers_to_nodes_first_two.png)

![](./write2pics/later/link_nodes_stored_in_array.png)

Now, the linked list is updating its next pointers to point to the subsequent nodes according to the previous array.

![](./write2pics/later/compate_nodes.png)
...
![](./write2pics/later/node_values.png)
...
![](./write2pics/later/thor_access_why_switch.png)
...
![](./write2pics/later/thor_access.png)

### thor access

![](./write2pics/turtle.gif)
